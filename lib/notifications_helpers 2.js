...
const sendEmailNewMessage = function(receiver){
  const msg = {
    ...
    html: `<strong>Hello ${receiver.name}, You got a new message in your Vend acount, please connect</strong>`,
  };
...
const sendSMSNewMessage = function(receiver){
  ...
  .create({
    to: '+15144338832',
    from: '+14388003069',
    body: `Hello ${receiver.name}, You got a new message in your Vend acount, please connect`,
  });
}
